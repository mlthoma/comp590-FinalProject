...
function configure() {
  ...
  uniform_shading = webgl_context.getUniformLocation(
    program,
    "shading_enabled"
  );
...
function allocateMemory() {
  ...
  webgl_context.bufferData(
    webgl_context.ARRAY_BUFFER,
    flatten(vertex_data),
    webgl_context.STATIC_DRAW
  );
...
function drawSun() {
  ...
  webgl_context.drawArrays(
    webgl_context.TRIANGLES,
    sun_axis_index,
    earth_axis_index - sun_axis_index
  );
}
...
function drawEarth(earthPos) {
  ...
  webgl_context.drawArrays(
    webgl_context.TRIANGLES,
    earth_axis_index,
    moon_axis_index - earth_axis_index
  );
}
...
function drawMoon(moonPos) {
  ...
  webgl_context.drawArrays(
    webgl_context.TRIANGLES,
    moon_axis_index,
    vertex_data.length - moon_axis_index
  );
}

function draw() {
  webgl_context.clear(
    webgl_context.COLOR_BUFFER_BIT | webgl_context.DEPTH_BUFFER_BIT
  );
